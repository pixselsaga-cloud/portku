  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-8 py-8 space-y-10">
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-end">
            ...
            {/* Sort Select */}
            <div className="flex items-center gap-2 bg-card-DEFAULT border border-card-border px-3 py-2 rounded-xl text-xs">
            ...
            {/* Layout Mode Toggle */}
            <div className="flex items-center gap-1 bg-card-DEFAULT border border-card-border p-1 rounded-xl">
              <button
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-card-DEFAULT border border-card-border rounded-2xl space-y-3">
          <p className="text-gray-400 text-sm">{t('works_empty')}</p>
        </div>
      ) : (
        <div
          className={
