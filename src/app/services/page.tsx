        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
          {servicesList.map((svc) => {
            ...
            return (
              <div
                key={svc.id}
                className="p-5 sm:p-6 rounded-2xl sm:rounded-3xl bg-card-DEFAULT border border-white/10 hover:border-accent-lime/50 transition-all duration-300 space-y-4 flex flex-col justify-between group hover:-translate-y-1 shadow-xl hover:shadow-accent-lime/10"
              >
